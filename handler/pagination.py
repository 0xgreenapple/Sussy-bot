...
class Sussypages(discord.ui.View):
    ...
    @discord.ui.button(emoji='<:icons8chevronleft100:975326725565190194>', style=discord.ButtonStyle.gray)
    async def go_to_previous_page(self, interaction: discord.Interaction, button: discord.ui.Button):
        """go to the previous page"""
        await self.show_checked_page(interaction, self.current_page - 1)

    @discord.ui.button(emoji='<:icons8chevronright100:975326725158346774>', style=discord.ButtonStyle.grey)
